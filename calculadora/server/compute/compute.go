...
// ConvertFunction converte a função utilizada na calculadora.
// 1 - Seno
// 2- Cosseno
// 3 - Tangente
// 4 - Cotangente
...
// 13 - Raiz quadrada
// 14 - Abs
func ConvertFunction (funcao string) int {
	if strings.Contains(funcao, "sen"){
		return 1
	} else if strings.Contains(funcao, "cos"){
		return 2
		} else if strings.Contains(funcao, "tan"){
		return 3
		} else if strings.Contains(funcao, "cot"){
		return 4
		} else if strings.Contains(funcao, "asen"){
		return 5
		} else if strings.Contains(funcao, "acos"){
		return 6
		} else if strings.Contains(funcao, "atan"){
		return 7
		} else if strings.Contains(funcao, "acot"){
		return 8
		} else if strings.Contains(funcao, "log"){
		return 9
		} else if strings.Contains(funcao, "ln"){
		return 10
		} else if strings.Contains(funcao, "lg"){
		return 11
		} else if strings.Contains(funcao, "mod"){
		return 12
		} else if strings.Contains(funcao, "sqrt"){
		return 13
		} else if strings.Contains(funcao, "abs"){
		return 14
}